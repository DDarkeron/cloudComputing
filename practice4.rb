...
proc do 
  ...
  Caller.new("Alex", ate).call("3434")
  Caller.new("John", ate).call("2345")
  Caller.new("Jordan",  ate).call("3434")
  Caller.new("Kate", ate).call("3434")
  Caller.new("Missy",  ate).call("2345")
  Caller.new("Kale",  ate).call("2345")
  Caller.new("Claus",  ate).call("3434")
end.()
